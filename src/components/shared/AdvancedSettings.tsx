...
export function AdvancedSettings() {
  ...
  return (
    <Collapsible open={showAdvanced} onOpenChange={toggleAdvanced}>
      <CollapsibleTrigger className="w-full flex items-center justify-between px-4 py-2.5 text-xs font-medium text-muted-foreground hover:text-white transition-colors group">
        ...
        <div className="grid grid-cols-2 gap-3 px-4 pb-4 pt-1">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              className="text-xs h-7 bg-surface-elevated border-white/[0.08]"
            />
          </div>
          <div className="space-y-1.5">
            <Label htmlFor="adv-guidance" className="text-xs text-muted-foreground">Guidance</Label>
            <Input
              id="adv-guidance"
              type="number"
              step={0.5}
          ...
          <div className="space-y-1.5">
            <Label htmlFor="adv-steps" className="text-xs text-muted-foreground">Steps</Label>
            <Input
              id="adv-steps"
              type="number"
          ...
          <div className="space-y-1.5">
            <Label htmlFor="adv-neg" className="text-xs text-muted-foreground">Neg. prompt</Label>
            <Input
              id="adv-neg"
